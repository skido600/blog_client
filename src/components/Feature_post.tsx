    ...
    return (
      <section className="py-10">
        <main className="container mx-auto px-5 sm:px-10 md:px-16 lg:px-24">
          <h1 className="text-2xl text-center font-semibold text-dark dark:text-light">
            Loading...
          </h1>
        </main>
      </section>
      ...
      <main className="container mx-auto px-5 sm:px-10 md:px-16 lg:px-24">
        ...
        <aside className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link
            ...
            className="md:col-span-2 relative group rounded-xl overflow-hidden h-96 md:h-auto block">
          ...
          <div className="md:col-span-1 space-y-6">
            {secondaryPosts.map((item) => (
              <Link to={`/post/${item._id}`} key={item._id}>
                <article className="group flex flex-col sm:flex-row md:flex-col gap-4 bg-light dark:bg-dark-foreground p-4 rounded-xl border border-neutral-500 transition-shadow duration-300">
